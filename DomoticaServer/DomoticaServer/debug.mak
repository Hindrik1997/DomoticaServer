...
INCLUDE_DIRS := ../Include/mysql ../Include/mysql++
LIBRARY_DIRS := ../Lib
...
CFLAGS := -ggdb -ffunction-sections -O0 -std=c++14 -pthread -lmysql -lmysqlpp
CXXFLAGS := -ggdb -ffunction-sections -O0 -std=c++14 -pthread -lmysql -lmysqlpp
ASFLAGS := 
